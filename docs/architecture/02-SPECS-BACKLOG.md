...
| 15 | Movimientos de inventario transaccionales | COMPLETED — VERIFIED por el usuario en producción, firestore.rules de `inventoryMovements` endurecida y desplegada | — | Medio (stock, menos usado que reservas/POS pero comparte `products` con SPEC-11) | [specs/SPEC-15-inventario-movimientos.md](specs/SPEC-15-inventario-movimientos.md) |
