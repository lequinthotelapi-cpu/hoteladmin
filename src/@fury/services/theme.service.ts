...
export type Theme = 'fury-default' | 'fury-light' | 'fury-dark' | 'fury-flat' | 'fury-ocean' | 'fury-ocean-dark';
...
export class ThemeService {
  ...
  setStyle(style: 'default' | 'flat' | 'dark' | 'light' | 'ocean' | 'ocean-dark' | 'top' | string) {
    switch (style) {
      case 'flat': {
        this._configSubject.next({
          navigation: 'side',
