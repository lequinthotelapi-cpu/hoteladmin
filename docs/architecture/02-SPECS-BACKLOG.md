...
| 15 | Movimientos de inventario transaccionales | IN PROGRESS (código completo y probado —99 tests emulador + 49 offline en verde—; falta que despliegues y confirmes) | — | Medio (stock, menos usado que reservas/POS pero comparte `products` con SPEC-11) | [specs/SPEC-15-inventario-movimientos.md](specs/SPEC-15-inventario-movimientos.md) |
